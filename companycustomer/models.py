...
class Customer(models.Model):
    ...
    country_code = models.ForeignKey(CountryCode, on_delete=models.CASCADE,related_name='customers_country_code')
    legal_email = models.EmailField()
    manager_name = models.CharField(max_length=100)
    manager_email = models.EmailField()
    manager_phone_country_code = models.ForeignKey(CountryCode, on_delete=models.CASCADE,                                    related_name='customers_manager_phone_country_code')
