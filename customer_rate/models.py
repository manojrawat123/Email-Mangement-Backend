...
class CustomerRateTable(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['user_id', 'rate_name'], name='unique_user_rate'),
            models.UniqueConstraint(fields=['user_id', 'customer_prefix'], name='unique_user_customer_prefix')
        ]
